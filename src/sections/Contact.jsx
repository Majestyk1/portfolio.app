      ...
      <div className="contact__container container">
        <div className="contact__content max-w-2xl mx-auto text-center">
          <div className="contact__header mb-12">
            <h2 className="contact__overline text-blue-400 font-mono text-base mb-4 tracking-wide">
              03. What's Next?
            </h2>
            <h3 className="contact__title text-4xl md:text-5xl font-bold text-gray-100 mb-6">
              Get In Touch
            </h3>
          </div>
