    ...
    <section id="about" className="about section-padding">
      <div className="about__container container">
        <div className="about__header mb-16">
          <h2 className="about__title text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
            <span className="text-blue-600 dark:text-blue-400 font-mono text-xl mr-4">01.</span>
            About Me
          </h2>
          <div className="about__title-line h-px bg-gray-200 dark:bg-gray-600 max-w-sm"></div>
        </div>
        ...
        <div className="about__content grid lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="about__story lg:col-span-2 order-2 lg:order-none">
            <div className="about__text space-y-6 text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
              <p>
              ...
              <p>
                ...
                Then life took a turn — I joined the <strong className="text-gray-900 dark:text-gray-100">U.S. military</strong>, where I spent years 
              ...
              <p>
                Now, I'm a <strong className="text-gray-900 dark:text-gray-100">full-stack developer</strong> with a couple years of hands-on 
                experience and a deep drive to build things that matter. I've honed my skills across both frontend 
                and backend — from crafting responsive interfaces in <strong className="text-blue-600 dark:text-blue-400">React</strong> and 
                <strong className="text-blue-600 dark:text-blue-400"> CSS</strong>, to deploying robust <strong className="text-blue-600 dark:text-blue-400">Node.js</strong> apps 
              ...
              <p>
                ...
                a desire to <strong className="text-gray-900 dark:text-gray-100">create positive change</strong> and leave things better than I found them.
              </p>
            ...
            <div className="about__skills mt-12">
              <p className="text-gray-700 dark:text-gray-300 mb-6">Here are a few technologies I've been working with recently:</p>
              <div className="about__skills-grid grid grid-cols-2 md:grid-cols-3 gap-2">
                {[
                  ...
                  <div key={skill} className="about__skill flex items-center text-gray-700 dark:text-gray-300">
          ...
          <div className="about__photo-container lg:col-span-1 order-1 lg:order-none">
            <div className="about__photo-wrapper relative max-w-sm mx-auto">
              <div className="about__photo-frame relative">
                <div className="about__photo bg-gradient-to-br from-blue-600 to-purple-500 dark:from-blue-400 dark:to-purple-500 rounded-lg aspect-square flex items-center justify-center text-6xl font-bold text-white">
                <img src={profilePhoto} alt="photo of Majestyk Vaughns" className="about__photo w-full h-full object-cover rounded-lg" />
                </div>
                <div className="about__photo-border absolute inset-0 border-2 border-blue-600 dark:border-blue-400 rounded-lg transform translate-x-4 translate-y-4 -z-10"></div>
              </div>
            </div>
          </div>
        </div>
