    ...
    <section id="projects" className="projects section-padding">
      <div className="projects__container container">
        <div className="projects__header inline-block mb-16">
          <h2 className="projects__title text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
            <span className="text-blue-600 dark:text-blue-400 font-mono text-xl mr-4">02.</span>
            Some Things I've Built
          </h2>
          <div className="projects__title-line h-px bg-gray-200 dark:bg-gray-600 w-full"></div>
        </div>
            ...
            <div key={project.id} className={`project-card grid lg:grid-cols-12 gap-8 items-center ${index % 2 === 1 ? 'lg:text-right' : ''}`}>
              ...
              <div className={`project-card__content lg:col-span-5 ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                <div className="project-card__meta">
                  ...
                  <h3 className="project-card__title text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                ...
                <div className="project-card__description bg-gray-100 dark:bg-gray-800 rounded-lg p-6 mb-6 shadow-xl">
                ...
                <div className="project-card__tech mb-6">
                  <ul className={`flex flex-wrap gap-3 ${index % 2 === 1 ? 'lg:justify-end' : ''}`}>
                    {project.tech.map((tech) => (
                      <li key={tech} className="text-gray-700 dark:text-gray-300 font-mono text-sm">
                        {tech}
                      </li>
                    ))}
                  </ul>
                ...
                <div className={`project-card__links flex gap-4 ${index % 2 === 1 ? 'lg:justify-end' : ''}`}>
                  <a 
                    href={project.github} 
                    className="project-card__link text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
        ...
        <div className="projects__other">
          <h3 className="projects__other-title text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8 text-center">
          ...
          <div className={`projects__other-grid gap-6 ${otherProjects.length === 1 ? 'flex justify-center' : 'grid md:grid-cols-2 lg:grid-cols-3'}`}>
            {otherProjects.map((project) => (
              <div key={project.id} className="project-card__small bg-gray-100 dark:bg-gray-800 rounded-lg p-6 hover:transform hover:-translate-y-2 transition-all duration-300">
                <div className="project-card__small-header flex justify-between items-center mb-4">
                  ...
                  <div className="project-card__small-links flex gap-3">
                    <a href={project.github} className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
                      </svg>
                    </a>
                    <a href={project.live} className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                ...
                <h4 className="project-card__small-title text-xl font-bold text-gray-900 dark:text-gray-100 mb-3 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  {project.title}
                </h4>
                <p className="project-card__small-description text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-4">
                  {project.description}
                </p>
                <div className="project-card__small-tech">
                  <ul className="flex flex-wrap gap-2">
                    {project.tech.map((tech) => (
                      <li key={tech} className="text-gray-600 dark:text-gray-400 font-mono text-xs">
                        {tech}
                      </li>
                    ))}
                  </ul>
